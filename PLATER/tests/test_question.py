...
def test_format_attribute():
    ...
    expected_trapi = {"knowledge_graph": {"nodes": {"CURIE:1": {"attributes": [
        ...
        {"original_attribute_name": "biolink:original_knowledge_source", "value": "infores:kg_source", "attribute_type_id": "biolink:original_knowledge_source", "value_type_id": "biolink:InformationResource"},
        {"attribute_type_id": "biolink:aggregator_knowledge_source", "value": "infores:automat.notspecified", "value_type_id": "biolink:InformationResource", "original_attribute_name": "biolink:aggregator_knowledge_source"}]
    }}}}
